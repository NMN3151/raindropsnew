                    ...
                    <div className="swiper-wrapper">
                        ...
                        <SwiperSlide>
                            <div className="banner__slider__image" >
                                <img src="/assets/images/neroscience/neuro/banner.jpg" alt="" 
                                // {/* <video src="/assets/images/banner/banner.mp4" */}
                                // autoPlay
                                // muted
                                // loop
                                // playsInline
                            ...
                            <div className="container">
                                <div className="row justify-content-center">
                                    <div className="col-lg-10">
                                                 <div className="banner__slide__content" style={{ 
              position: 'absolute',
              top: '50%',
              left: '50%',
              ...
              zIndex: 3
                                            ...
                                            <h1> Wellness </h1>
                                             <p className="sub__text">
                                                Wellness with Rain drops – Where Peace Flows Natural
                                            </p>
                                        </div>
                                    </div>
                                </div>
