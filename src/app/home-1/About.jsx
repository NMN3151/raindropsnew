                    ...
                    <div className="about__wrapper">
                        <div className="image">
                            ...
                            <div className="image__card radius-10 wow fadeInUp" data-wow-delay=".5s">
                                ...
                                <div className="content">
                                    ...
                                    <p> Exceptional Minds<br></br>At work</p>
                                </div>
                            </div>
                        ...
                        <div className="content">
                            ...
                            <p className="content__subtitle wow fadeInUp" data-wow-delay=".3s">
                               A rare and refined wellness experience for those who seek more than a retreat,  they seek themselves.
                               Just a mile from the <strong style={{color:'#a8915b'}}>Sinharaja UNESCO Rainforest</strong>, Rain Drops is an intimate sanctuary where original mindfulness, advanced neuroscience, presidential-level culinary mastery, and a private research center come together exclusively for you.
                                <br></br>  <br></br>
                               Here, nature doesn’t just surround you,
                               it welcomes you, aligns with you, and restores you.

                               Your stay is curated to help you cultivate calm and truly enjoy it through:
                               mind-designed cuisine, forest-guided meditations, real-time brain clarity tracking,
                               and villa interiors crafted with natural luxury and quiet elegance.
                                 <br></br>  <br></br>
                                  <strong>At Rain Drops, where luxury becomes personal, science becomes human, and the rainforest becomes your private guide to clarity.</strong>
                            </p>
