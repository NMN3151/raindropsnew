        ...
        <div className="swiper-wrapper">
          <SwiperSlide>
            <div className="banner__slider__image">
              <img src="/assets/images/weather/cdcdcd.png" alt="" />
            </div>
                ...
                <div className="col-lg-10">
                  ...
                  >
                    ...
                    <p data-aos="fade-up" data-aos-delay="600">
                      Experience the living rainforest where silence, mist, and
                      nature gently reshape your inner world
                    </p>
